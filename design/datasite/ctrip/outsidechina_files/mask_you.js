...
var ssoVariables = {
    H1: sso_envi == "prd" ? 'https' : 'http',
    AjaxUrl: sso_envi == "dev" ? 'accounts.dev.sh.ctriptravel.com' : (sso_envi == "fat" ? 'accounts.fat49.qa.nt.ctripcorp.com' : (sso_envi == "uat" ? 'accounts.uat.sh.ctriptravel.com' : 'accounts.ctrip.com'))
};
...
document.write("<script type='text/javascript' src='" + ssoVariables.H1 + "://webresource.c-ctrip.com/ResCRMOnline/R6/member/common/js/client_you.js?20140617' charset='utf-8' ></script>");
